...
parameters=dict(input_size=input_size,output_size=output_size,reduced_size=reduced_size,dropout_p=dropout_p,initializer=initializer,initializer_b=initializer_b, architecture_e=architecture_e,architecture_d=architecture_d, alpha=alpha)
...
for i in range(len(monitors)):
    ...
    for j in range(len(repetitions)):
        ...
        for train_index,test_index in RepeatedKFold(n_splits=n_split, n_repeats=n_repeats,random_state=42).split(Inputs):
            ...
            Autoencoder=NN()
            #Autoencoder.build((input_size,))#input_size=input_size,output_size=output_size,reduced_size=reduced_size,dropout_p=dropout_p,initializer=initializer,initializer_b=initializer_b, architecture_e=architecture_e,architecture_d=architecture_d, alpha=alpha)
            print(Autoencoder)#input_size=input_size,output_size=output_size,reduced_size=reduced_size,dropout_p=dropout_p,initializer=initializer,initializer_b=initializer_b, architecture_e=architecture_e,architecture_d=architecture_d, alpha=alpha)
